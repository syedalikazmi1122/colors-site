        ...
        <div className="relative">
          ...
          >
            {furnitureItems.map((item, index) => (
              <div key={index} className="flex-none w-48 mx-3 snap-start">
                <div className="group">
                  <div className="relative mb-4">
                    <img
                      src={item.image}
                      alt={item.name}
                      className="w-full h-64 object-cover object-center bg-gray-100 rounded"
                    />
                  </div>
                  ...
                  <div className="space-y-1">
                    ...
                    <div className="flex flex-wrap items-baseline gap-x-1.5 text-[13px]">
                      {item.prefix && <span className="text-gray-900">From</span>}
