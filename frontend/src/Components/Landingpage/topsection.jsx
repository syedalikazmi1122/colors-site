...
export default function BedroomSaleSection({TopSectionData}) {
  console.log(TopSectionData[0], "TopSectionData")
  return (
    <div className="relative h-[600px] w-full">
      ...
      <div 
        className="absolute inset-0 bg-cover bg-center"
        style={{
          backgroundImage: `url(${TopSectionData[0]?.url || "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR8_XIZrXiVEUUut8om-0KgO8OC6fOouvU3_w&s"})`
        }}
      ></div>
      ...
      <div className="relative z-10 h-full flex p-10 justify-end  ">
        <div className="text-right pr-20">
          <h2 className="text-6xl font-medium tracking-wide text-white mb-4">
            {TopSectionData[0]?.title || "Spring Sale"}
          </h2>
